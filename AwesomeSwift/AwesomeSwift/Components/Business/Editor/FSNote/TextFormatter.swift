...
public class TextFormatter {
    ...
    private var textView: EditTextView
...
//                note.save(attributed: attributed)
    ...
    func toggleBoldFont(font: UIFont) -> UIFont {
        if (font.isBold) {
            return font.unBold()
        } else {
            return font.bold()
    ...
    func toggleItalicFont(font: UIFont) -> UIFont {
        if (font.isItalic) {
    ...
    func getTypingAttributes() -> UIFont {
        #if os(OSX)
    ...
    func setTypingAttributes(font: UIFont) {
        #if os(OSX)
